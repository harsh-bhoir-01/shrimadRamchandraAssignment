...
const Celebrations = () => {
  return (
    <div id="gaamCelebration" className=" bg-[#ffefd3] py-16 lg:px-20   ">
      <div className="text-[#9E1F22] font-crimson">
      ...
      <div className=" p-6 md:px-12 ">
        <div className="md:grid grid-cols-3 gap-5 md:mt-5">
          {/* div 1 - Takes 2 columns, full height */}
          ...
          <div className="mt-5 md:mt-0 col-span-1 flex flex-col gap-4">
            ...
            <div className=" flex  justify-center items-center rounded-3xl bg-[#E3B055] px-[20px] py-[13px] md:p-3 lg:p-5 flex-[0.9] ">
              <h3
                className="text-[19px] 
               text-[#9E1F22] font-inknut font-[550] text-center lg:text-3xl xl:text-3xl 2xl:leading-10 2xl:p-10 "
              >
